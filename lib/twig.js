...
class Elt {
    ...
    * You can provide any filter by callback function, e.g. (name, value) => { return name === 'foo' && value === 'bar'}
    * @param {?string} value - New value of the attribute
   ...
   attribute = function (cond, value) {
      if (value === undefined) {
         ...
         if (cond === undefined) {
            ...
            attr = Object.fromEntries(Object.entries(this.#attributes).filter(([key, value]) => cond(key, value)));
